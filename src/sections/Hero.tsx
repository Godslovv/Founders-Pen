...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-[#070c23] text-white">
      <div className="mx-auto flex w-full md:max-w-6xl flex-col gap-12 px-6 pb-24 pt-5 md:pb-32 md:pt-16 items-center text-center">
      ...
      <div className="absolute bottom-0 left-0 w-full -mb-px h-[60px] sm:h-[80px] md:h-[120px]">
        <svg
